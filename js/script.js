...
function adaptive_header(w, h) {
	...
	var headerLang = $('.navigation__block');
	if (w < 767) {
		...
		if (headerLang.hasClass('done')) {
			headerLang.removeClass('done').appendTo($('.header__column-navigation'));
		}
	}
}
...
let videoBtn = document.querySelector('.header__contetn-video--preview-button'),
	videoBlock = document.querySelector('.header__contetn-video--preview'),
	video = document.querySelector('.header__content-vid');
...
videoBtn.addEventListener('click', videoFunc);


var mySwiper = new Swiper('.swiper-container-feedback', {
	// Optional parameters
	direction: 'vertical',
	loop: true,
	slidesPerView: 2,
